...
cvresult = xgb.cv(xgb_param, xgtrain, num_boost_round=xgb1.get_params()['n_estimators'], nfold=5,
    metrics='auc', early_stopping_rounds=100,verbose_eval=10)
...
#clf.best_score_ 0.8056806202441876
#clf.best_params_ {'max_depth': 3, 'min_child_weight': 1}
...
#clf.best_score_ 0.8164055162632013
#clf.best_params_ {'colsample_bytree': 1.0, 'subsample': 0.6}
...
#clf.best_score_ 0.8274112088628218
#clf.best_params_ {'reg_alpha': 0, 'reg_lambda': 2}

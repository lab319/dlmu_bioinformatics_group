...
for(i in 0:99)
  {	
	...
	fit = glmnet(x_train, y=y_train, family='binomial', alpha=0.1, lambda= 1.707213)
	print(fit)
	
	predict<-predict(fit,x_test,type="class",s=1.707213)
	predictions<-predict.glmnet(fit,x_test,type="class",s=1.707213)
	predictions

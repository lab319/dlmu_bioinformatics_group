...
grid2 = GridSearchCV(clf,param_digits,scoring='roc_auc',verbose=True)
...
#('grid2.best_score_', 0.7402921953094964)
#('grid2.best_params_', {'n_neighbors': 4, 'weights': 'distance', 'p': 5})

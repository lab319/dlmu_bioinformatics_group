...
grid2 = GridSearchCV(clf,param_digits,cv=5,scoring='roc_auc',verbose=True)
...
#('grid2.best_score_', 0.702853247848504)
#('grid2.best_params_', {'n_neighbors': 5, 'weights': 'distance', 'p': 1})

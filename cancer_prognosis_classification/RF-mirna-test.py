...
for i in range(100):
    ...
    score_auc=str(auc)+'\n'           
    df_1=open('kirp-rf-aucs-mirna.txt','a')
    df_1.write(score_auc)
    
    score_acc=str(acc)+'\n'           
    df_1=open('kirp-rf-accs-mirna.txt','a')
    df_1.write(score_acc)
    
    score_pr_auc=str(pr_auc)+'\n'           
    df_1=open('kirp-rf-prauc-mirna.txt','a')
    df_1.write(score_pr_auc)
    
    score_mcc=str(mcc)+'\n'           
    df_1=open('kirp-rf-mcc-mirna.txt','a')
    df_1.write(score_mcc)
   
    score_sen=str(sen)+'\n'           
    df_1=open('kirp-rf-sen-mirna.txt','a')
    df_1.write(score_sen)
    
    score_sps=str(sps)+'\n'           
    df_1=open('kirp-rf-sps-mirna.txt','a')
...
'''
auc-mean-score: 0.813
acc-mean-score: 0.795
pr-mean-score: 0.902
mcc-mean-score: 0.389
sen-mean-score: 0.949
sps-mean-score: 0.345
'''

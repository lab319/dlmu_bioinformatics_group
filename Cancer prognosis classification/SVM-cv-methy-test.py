...
for i in range(100):
    ...
    score_auc=str(auc)+'\n'           
    df_1=open('svm-aucs-methy.txt','a')
    df_1.write(score_auc)
    
    score_acc=str(acc)+'\n'           
    df_1=open('svm-accs-methy.txt','a')
    df_1.write(score_acc)
    
    score_pr_auc=str(pr_auc)+'\n'           
    df_1=open('svm-prauc-methy.txt','a')
...
auc-median-score: 0.867
acc-mean-score: 0.834
acc-median-score: 0.843
pr-mean-score: 0.930
pr-median-score: 0.940
mcc-mean-score: 0.525
mcc-median-score: 0.551
sen-mean-score: 0.969
sen-median-score: 0.974

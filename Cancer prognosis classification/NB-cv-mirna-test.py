...
for i in range(100):
    ...
    score_auc=str(auc)+'\n'           
    df_1=open('kirp-nb-aucs-mirna.txt','a')
    df_1.write(score_auc)
    
    score_acc=str(acc)+'\n'           
    df_1=open('kirp-nb-accs-mirna.txt','a')
    df_1.write(score_acc)
    
    score_pr_auc=str(pr_auc)+'\n'           
    df_1=open('kirp-nb-prauc-mirna.txt','a')
    df_1.write(score_pr_auc)
    
    score_mcc=str(mcc)+'\n'           
    df_1=open('kirp-nb-mcc-mirna.txt','a')
    df_1.write(score_mcc)
   
    score_sen=str(sen)+'\n'           
    df_1=open('kirp-nb-sen-mirna.txt','a')
    df_1.write(score_sen)
    
    score_sps=str(sps)+'\n'           
    df_1=open('kirp-nb-sps-mirna.txt','a')
...
'''
auc-mean-score: 0.818
auc-median-score: 0.829
acc-mean-score: 0.817
acc-median-score: 0.824
pr-mean-score: 0.931
pr-median-score: 0.934
mcc-mean-score: 0.543
mcc-median-score: 0.551
sen-mean-score: 0.860
sen-median-score: 0.868
sps-mean-score: 0.692
sps-median-score : 0.692
'''
...
for i in range(100):
    ...
    score_auc=str(auc)+'\n'           
    df_1=open('kirp-nb-aucs-mrna.txt','a')
    df_1.write(score_auc)
    
    score_acc=str(acc)+'\n'           
    df_1=open('kirp-nb-accs-mrna.txt','a')
    df_1.write(score_acc)
    
    score_pr_auc=str(pr_auc)+'\n'           
    df_1=open('kirp-nb-prauc-mrna.txt','a')
    df_1.write(score_pr_auc)
    
    score_mcc=str(mcc)+'\n'           
    df_1=open('kirp-nb-mcc-mrna.txt','a')
    df_1.write(score_mcc)
   
    score_sen=str(sen)+'\n'           
    df_1=open('kirp-nb-sen-mrna.txt','a')
    df_1.write(score_sen)
    
    score_sps=str(sps)+'\n'           
    df_1=open('kirp-nb-sps-mrna.txt','a')
...
'''
auc-mean-score: 0.715
auc-median-score: 0.716
acc-mean-score: 0.797
acc-median-score: 0.804
pr-mean-score: 0.911
pr-median-score: 0.909
mcc-mean-score: 0.445
mcc-median-score: 0.437
sen-mean-score: 0.887
sen-median-score: 0.895
sps-mean-score: 0.533
sps-median-score : 0.538
'''
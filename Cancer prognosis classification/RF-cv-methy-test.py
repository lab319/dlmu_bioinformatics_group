...
for i in range(100):
    ...
    score_auc=str(auc)+'\n'           
    df_1=open('kirp-rf-aucs-methy.txt','a')
    df_1.write(score_auc)
    
    score_acc=str(acc)+'\n'           
    df_1=open('kirp-rf-accs-methy.txt','a')
    df_1.write(score_acc)
    
    score_pr_auc=str(pr_auc)+'\n'           
    df_1=open('kirc-rf-prauc-methy.txt','a')
    df_1.write(score_pr_auc)
    
    score_mcc=str(mcc)+'\n'           
    df_1=open('kirp-rf-mcc-methy.txt','a')
    df_1.write(score_mcc)
   
    score_sen=str(sen)+'\n'           
    df_1=open('kirp-rf-sen-methy.txt','a')
    df_1.write(score_sen)
    
    score_sps=str(sps)+'\n'           
    df_1=open('kirp-rf-sps-methy.txt','a')
...
'''
auc-mean-score: 0.852
acc-mean-score: 0.826
pr-mean-score: 0.937
mcc-mean-score: 0.492
sen-mean-score: 0.965
sps-mean-score: 0.419
'''

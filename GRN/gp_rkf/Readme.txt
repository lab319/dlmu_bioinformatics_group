This folder contains the code for genetic programming (GP) and robust Kalman filter (RKF), and the datasets of E_cell,yeast and HeLa.
...
gppf_lsq.m : Estimate parameters using robust Kalman filter and error values

This folder contains the code for genetic programming (GP) and recursive least square (RLS), and the datasets of E_cell,yeast and HeLa.
...
gppf_lsq.m : Estimate parameters using recursive least square and error values

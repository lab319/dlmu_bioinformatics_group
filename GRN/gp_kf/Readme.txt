This folder contains the code for genetic programming (GP) and Kalman filter (KF), and the datasets of E_cell,yeast and HeLa.
...
gppf_lsq.m : Estimate parameters using Kalman filter and error values
